...
namespace ContractMonthlyClaimSystem2.Models
{
    ...
    public class Claim : INotifyPropertyChanged
    {
        ...
        // Amount is calculated, not stored
        public decimal Amount
        {
            get => _hoursWorked * _hourlyRate;
            set { _hoursWorked = value; OnPropertyChanged(nameof(Amount)); OnPropertyChanged(nameof(Amount)); }
        ...
        {
            get => _documents ?? new List<Document>();
            set { _documents = value ?? new List<Document>(); OnPropertyChanged(nameof(Documents)); }
        }
