...
namespace ContractMonthlyClaimSystem2
{
    public partial class ManagerDashboard : Window
    {
        ...
        public ObservableCollection<Claim> AllClaims { get; set; } = new ObservableCollection<Claim>();
        public ObservableCollection<Claim> FilteredClaims { get; set; } = new ObservableCollection<Claim>();
        ...
        public ManagerDashboard(string email, string role)
        {
            ...
            // Prevent ApplyFilter from being called too early
            cmbFilter.SelectionChanged -= FilterComboBox_SelectionChanged;
        }
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            // Ensure data grid is correctly bound
            claimsDataGrid.ItemsSource = FilteredClaims;

            // Set default filter
            cmbFilter.SelectedIndex = 0;

            // Re-enable event now that everything is loaded
            cmbFilter.SelectionChanged += FilterComboBox_SelectionChanged;
        ...
        {
            // Prevent null crash
            if (FilteredClaims == null || AllClaims == null || cmbFilter.SelectedItem == null)
                return;
        ...
        private void UpdateDashboardStats()
        {
            ...
            lblStats.Content =
                $"Total: {AllClaims.Count} | Pending: {underReview} | Approved: {approved} | Paid: {paid} | Rejected: {rejected} | Total Approved: R{totalApproved:N2}";
        }
